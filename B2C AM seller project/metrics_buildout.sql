...
SELECT *
FROM P_nishant_local_T.GMV_T1_METRICS
WHERE SLR_ID = 37762
...
select *
from P_nishant_local_T.GMV_T52_METRICS
limit 10
...
SELECT *
FROM P_nishant_local_T.LL_T1_METRICS
LIMIT 100
...
SELECT COUNT(*)
FROM P_nishant_local_T.T1W_DEFECT_METRICS
LIMIT 10
...
select *
from P_nishant_local_T.T52W_DEFECT_METRICS
limit 200
...
SELECT *
FROM P_nishant_local_T.STORE_KPI_METRICS
LIMIT 100
...
SELECT *
FROM P_nishant_local_T.T1W_NSH_USAGE_METRICS
LIMIT 10
...
SELECT *
FROM P_nishant_local_T.T52W_NSH_USAGE_METRICS
LIMIT 100
...
select *
from P_nishant_local_T.T52W_FVF_METRICS
limit 10
...
SELECT * FROM P_CSI_TBS_V.PL_LOBS_REV
limit 10
...
SELECT A.RETAIL_YEAR, A.RETAIL_WEEK, A.SLR_ID,
	   A.T1W_GMV, A.T1W_SI, A.T1W_CBT_GMV, A.T1W_CBT_SI,
	   B.T52W_GMV, B.T52W_SI, B.T52W_CBT_GMV, B.T52W_CBT_SI,
	   C.T1W_LL,
	   D.T52W_LL,
